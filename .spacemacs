...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(modern-cpp-font-lock lsp-elixir fzf company-box cov pcmpl-args pcomplete-extension)
